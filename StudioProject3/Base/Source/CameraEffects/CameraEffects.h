...
public:
	...
	Mesh* m_CameraEffects_HealthScreen;
	...
	bool SetHealthScreen(Mesh* aTarget);
	Mesh* GetHealthScreen(void) const;
	...
	// Set boolean flag for BloodScreen
	bool SetStatus_HealthScreen(const bool m_bStatusHealthScreen);
	// Set Countdown Timer for BloodScreen
	bool SetTimer_HealthScreen(const float m_fCountdownTimer_HealthScreen = 2.0f);
	// Get Countdown Timer for BloodScreen
	float GetTimer_HealthScreen(void) const;
...
protected:
	...
	// Boolean flag to indicate if the BloodScreen is rendered
	bool m_bStatusHealthScreen;
	// Countdown Timer for BloodScreen
	float m_fCountdownTimer_HealthScreen;
