...
//bool CMinimap::SetPosition(const int m_iPos_X, const int m_iPos_y)
//{
//	this->m_iPos_x = m_iPos_X;
//	this->m_iPos_y = m_iPos_y;
//	return true;
//}
//// Get position x of avatar in minimap
//int CMinimap::GetPosition_x(void) const
//{
//	return m_iPos_x;
//}
//// Get position y of avatar in minimap
//int CMinimap::GetPosition_y(void) const
//{
//	return m_iPos_y;
//}
//// Set size of minimap (for calculation of avatar in minimap)
//bool CMinimap::SetSize(const int m_iSize_x, const int m_iSize_y)
//{
//	this->m_iSize_x = m_iSize_x;
//	this->m_iSize_y = m_iSize_y;
//	return true;
//}
//// Get size of minimap (for calculation of avatar in minimap)
//int CMinimap::GetSize_x(void) const
//{
//	return m_iSize_x;
//}
//// Get size of minimap (for calculation of avatar in minimap)
//int CMinimap::GetSize_y(void) const
//{
//	return m_iSize_y;
//}
...
void CMinimap::RenderUI()
{
	...
	modelStack.PushMatrix();
		...
		modelStack.PushMatrix();
			...
			glColorMask(GL_FALSE, GL_FALSE, GL_FALSE, GL_FALSE); // Don't write to depth buffer
			...
			glColorMask(GL_TRUE, GL_TRUE, GL_TRUE, GL_TRUE); // Don't write to depth buffer
...
void CMinimap::RenderUIWithBlend()
{
	glDisable(GL_DEPTH_TEST);
	// Enable blend mode
	glEnable(GL_BLEND);
